...
import AIPriceCalculator from '../components/ai-hub/AIPriceCalculator';
...
const AIHubProductionPage: React.FC = () => {
  ...
  return (
    <div className="bg-[#FAF8F4]">
      ...
      {/* AI Price Calculator — always available, no API keys needed */}
      <AIPriceCalculator />
    </div>
  );
};
...
const AIHubDevPage: React.FC = () => {
  ...
  return (
    <div className="bg-[#FAF8F4] min-h-screen">
      ...
      {/* AI Price Calculator — no API keys needed, always live */}
      <AIPriceCalculator />
